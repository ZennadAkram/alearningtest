...
import 'teacher_u_i_model.dart';
export 'teacher_u_i_model.dart';

class TeacherUIWidget extends StatefulWidget {
  const TeacherUIWidget({super.key});

  @override
  State<TeacherUIWidget> createState() => _TeacherUIWidgetState();
}

class _TeacherUIWidgetState extends State<TeacherUIWidget> {
  late TeacherUIModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TeacherUIModel());
