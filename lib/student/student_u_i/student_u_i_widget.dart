...
import 'student_u_i_model.dart';
export 'student_u_i_model.dart';

class StudentUIWidget extends StatefulWidget {
  const StudentUIWidget({super.key});

  @override
  State<StudentUIWidget> createState() => _StudentUIWidgetState();
}

class _StudentUIWidgetState extends State<StudentUIWidget> {
  late StudentUIModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => StudentUIModel());
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              InkWell(
                                ...
                                onTap: () async {
                                  context
                                      .pushNamed('student_module_assignments');
                                },
                                child: Row(
