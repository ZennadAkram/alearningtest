...
import 'students_timeplate_model.dart';
export 'students_timeplate_model.dart';

class StudentsTimeplateWidget extends StatefulWidget {
  const StudentsTimeplateWidget({super.key});

  @override
  State<StudentsTimeplateWidget> createState() =>
      _StudentsTimeplateWidgetState();
}

class _StudentsTimeplateWidgetState extends State<StudentsTimeplateWidget> {
  late StudentsTimeplateModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => StudentsTimeplateModel());
