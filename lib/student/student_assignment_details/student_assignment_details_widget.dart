...
import 'student_assignment_details_model.dart';
export 'student_assignment_details_model.dart';

class StudentAssignmentDetailsWidget extends StatefulWidget {
  const StudentAssignmentDetailsWidget({super.key});

  @override
  State<StudentAssignmentDetailsWidget> createState() =>
      _StudentAssignmentDetailsWidgetState();
}

class _StudentAssignmentDetailsWidgetState
    extends State<StudentAssignmentDetailsWidget> {
  late StudentAssignmentDetailsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => StudentAssignmentDetailsModel());
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            ...
                                            InkWell(
                                              ...
                                              onTap: () async {
                                                await launchURL(
                                                    'https://youtu.be/liMJ2sNCbLY?si=fW11nJns5cHlb9Er');
                                              },
                                              child: Icon(
                                                Icons.open_in_new,
                                                color:
